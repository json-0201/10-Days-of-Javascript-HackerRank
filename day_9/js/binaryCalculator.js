    ...
    if (!isOperator()) {
        ...
        while (ops.length > 0) {
            ...
            if (ops.includes("*")) {
                ...
                let mul = (ind_mul != 0 ? parseInt(nums[ind_mul - 1], 2) : parseInt(nums[ind_mul], 2)) * parseInt(nums[ind_mul + 1], 2);
            ...
            // division algorithm -> priority
                ...
                let div = Math.trunc((ind_div != 0 ? parseInt(nums[ind_div - 1], 2) : parseInt(nums[ind_div], 2)) / parseInt(nums[ind_div + 1], 2));
            ...
            // addition algorithm
                ...
                let sum = (ind_sum != 0 ? parseInt(nums[ind_sum - 1], 2) : parseInt(nums[ind_sum], 2)) + parseInt(nums[ind_sum + 1], 2);
            ...
            // subtraction algorithm
                ...
                let sub = (ind_sub != 0 ? parseInt(nums[ind_sub - 1], 2) : parseInt(nums[ind_sub], 2)) - parseInt(nums[ind_sub + 1], 2);
